...
- [Switch Sports gallery](https://miiwiki.org/wiki/Nintendo_Switch_Sports/gallery): gallery text fetched, including Mii character menus. Parent task gathers gallery screenshots and round footage for visual comparisons.
...
The prior screenshots `07-ui-after.png`, `07-locker.png` and `07-hud.png` are the before evidence for clubhouse, locker and HUD respectively. Physical Android and iPhone frame rates remain owed. Blind comparison wins require the separate critic's recorded result.
