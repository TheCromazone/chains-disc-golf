...
console.log(`Animation contract OK: 22 distinct RH/LH throw clips, ${checked} authored joint samples; positive scales; exact .62 release.`);
...
console.log('All eleven release poses preserve nonzero, continuous angular momentum.');
